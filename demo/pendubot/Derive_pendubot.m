...
sumTorques1 = cross2d(p1,-m1*g*j) + cross2d(p2,-m2*g*j) + u;
...
sumTorques2 = cross2d(p2-p1,-m2*g*j);
...
matlabFunction(MM(1,1),MM(1,2),MM(2,1),MM(2,2),ff(1),ff(2),...
    'file','autoGen_pendubotDynamics.m',...
...
matlabFunction(A,B, ...
    'file','autoGen_pendubotLinearization.m', ...
    'vars',{q1,q2,dq1,dq2,u,m1,m2,g,l1,l2}, ...
    'outputs',{'A','B'});
